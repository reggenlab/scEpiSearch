...
data_seurat <- read.csv('/storage/vibhor/neeteshp/shreyas_tools_testing/seurat-embed/embeds-MCA-cell-Human-pbmc.txt', header = TRUE,sep="\t")
drops <- c("X")
...
data_conos <- read.csv('/storage/vibhor/neeteshp/shreyas_tools_testing/tsne_coords/pbmc_conos_tsne.txt.csv',sep=",")
data_conos <- data_conos[-c(1,2,6,7)]
...
data_liger <- read.csv('/storage/vibhor/neeteshp/shreyas_tools_testing/tsne_coords/liger_pbmc_tsne.txt', header = TRUE,sep="\t")
...
data_scepi <- read.csv('/storage/vibhor/neeteshp/shreyas_tools_testing/tsne_coords/pbmc_scepi_tsne.txt', header = TRUE,sep=" ")
