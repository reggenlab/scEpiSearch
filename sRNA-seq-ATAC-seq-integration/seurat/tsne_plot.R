##ggplot based
data = read.csv("scRNA-scATAC-integration/seurat-embed/mouse/embeds-MCA-cell-Mouse-liver-3cells.txt",sep="\t")
#data = read.csv("scRNA-scATAC-integration/seurat-embed/mouse/embeds-MCA-cell-Mouse-macrophages.txt",sep="\t")
#data = read.csv("scRNA-scATAC-integration/seurat-embed/mouse/embeds-MCA-cell-Mouse-endothelial.txt",sep="\t")
#data = read.csv("scRNA-scATAC-integration/seurat-embed/embeds-MCA-cell-Human-HESC.txt",sep="\t")
#data = read.csv("scRNA-scATAC-integration/seurat-embed/embeds-MCA-cell-Human-pbmc.txt",sep="\t")
#data = read.csv("scRNA-scATAC-integration/seurat-embed/embeds-MCA-cell-Human-neuron.txt",sep="\t")
#data = read.csv("scRNA-scATAC-integration/seurat-embed/embeds-MCA-cell-Human-GM.txt",sep="\t")
