...
data = read.csv("liger/liger_3cell_mouse_tsne.txt",sep="\t")
#data = read.csv("liger/GM_liger_tsne.txt.csv",sep=",")
#data = read.csv("liger/h1esc_liger_tsne.txt.csv",sep=",")
#data = read.csv("liger/liger_endothelial_mouse_tsne.txt",sep="\t")
#data = read.csv("liger/liger_macrophae_mouse_tsne.txt",sep="\t")
#data = read.csv("liger/liger_pbmc_tsne.txt",sep="\t")
#data = data[,c(2,3,4)]
#data = read.csv("liger/myoblast_liger_tsne.txt.csv",sep=",")
#data = read.csv("liger/neuron_liger_tsne.csv",sep=",")
